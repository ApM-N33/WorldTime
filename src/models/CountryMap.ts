...
export class CountryMap implements ICountryMap {
  public countryLabel: Maybe<HTMLElement>
  public countryName: Maybe<HTMLElement>
  public totalTimezones: Maybe<HTMLElement>
  public countryCurrency: Maybe<HTMLElement>
  public timezonesList: Maybe<HTMLElement>
  public flagLogo: Maybe<HTMLImageElement>
  public deleteCountryBtn: Maybe<HTMLElement>
  public checkboxInput: Maybe<TInputEl>

  constructor() {
    this.countryLabel = null
    this.countryName = null
    this.totalTimezones = null
    this.countryCurrency = null
    this.timezonesList = null
    this.flagLogo = null
    this.deleteCountryBtn = null
    this.checkboxInput = null
  }

  public create() {
    const countryMapCard = document.createElement("article")
    addClass(countryMapCard, "country-map-card")
    countryMapCard.innerHTML = /* html */ `
      <div class="country-map-card__header">
      <div class="country-map-card__title-wrapper">
        <label class="input input--checkbox-label">
          ...
          <h5 class="country-map-card__title">
            <span class="country-map-card__country-label"></span>
              <span class="country-map-card__country-name-wrap">
                <span class="country-map-card__country-name"></span>
                <span class="logo logo--flag logo--country-map-card-flag">
                  <img class="logo--flag__img" src="" alt=""/>
                </span>
            </span>
          </h5>
        </div>
        <button class="btn btn--delete btn--delete-country">
      ...
      <div class="country-map-card__footer">
        ...
        <p class="country-map-card__country-currency"></p>
      </div>`

    this.countryLabel = $(
      ".country-map-card__country-label",
      "one",
      countryMapCard,
    )
    this.countryName = $(
      ".country-map-card__country-name",
      "one",
      countryMapCard,
    )
    this.totalTimezones = $(
      ".country-map-card__total-timezones",
      "one",
      countryMapCard,
    )
    this.countryCurrency = $(
      ".country-map-card__country-currency",
      "one",
      countryMapCard,
    )
    this.flagLogo = $<HTMLImageElement>(
      ".logo--flag__img",
      "one",
      countryMapCard,
    )
